...
_AXES = [
    ...
    dict(Bmul=1.0, K=4, pos_lam=0.12, order="rank", fut_beta=1.0, prefw=0.0, w3mul=3.0, cohort=0.3),
    dict(Bmul=0.7, K=5, pos_lam=0.15, order="rank",    fut_beta=0.0, prefw=0.0, w3mul=3.0, cohort=0.3),
