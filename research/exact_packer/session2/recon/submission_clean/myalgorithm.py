# VERSION: 2026-v7-parallel-numba (v6 core + cooperative parallel ALNS
...
# VERSION: 2026-v6-parallel (v6 core + cooperative parallel ALNS:
...
# ----------------------------------------------------------------------------
# Cooperative parallel orchestration
# ----------------------------------------------------------------------------
...
def _w3mul_of(prob_info, base):
    ...
    cannot express that.  An alternative decomposition on the same instances shows higher Z1 and
...
#   order   : the largest single effect (edd_tri2 = selective defer-big, the
#             defer lever: +1 tardy on a big released into an already-full yard buys room for
