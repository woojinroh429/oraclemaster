...
#             crane descents.
_AXES = [
    dict(Bmul=1.0, K=4, pos_lam=4, order="defer_big", fut_beta=1.0, prefw=0.0, w3mul=1.0, cohort=0.0),
    dict(Bmul=1.0, K=4, pos_lam=4.8, order="defer_big", fut_beta=1.0, prefw=0.0, w3mul=3.0, cohort=0.3),
    dict(Bmul=0.7, K=5, pos_lam=6, order="lst",       fut_beta=0.0, prefw=0.0, w3mul=3.0, cohort=0.3),
    dict(Bmul=0.7, K=5, pos_lam=2, order="edd",       fut_beta=1.5, prefw=0.0, w3mul=1.0, cohort=0.3),
    dict(Bmul=1.4, K=3, pos_lam=4, order="big_first", fut_beta=0.5, prefw=0.0, w3mul=6.0, cohort=0.3),
    dict(Bmul=0.5, K=6, pos_lam=8, order="defer_big", fut_beta=0.0, prefw=0.0, w3mul=1.5, cohort=0.0),
]
